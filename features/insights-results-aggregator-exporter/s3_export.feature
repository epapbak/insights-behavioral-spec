...
Feature: Ability to export tables into S3
  ...
  Scenario: Check export from REPORT table into S3/Minio
     ...
     When I insert following records into REPORT table
      ...
      And I run the exporter with the following command line flags: --output S3
     Then The process should finish with exit code 0
      And I should see following objects generated in S3
          | File name                              |
          | advisor_ratings.csv                    |
      ...
      And I should see following number of records stored in CSV objects in S3
          ...
          | rule_disable.csv                       | 0       |
          | rule_hit.csv                           | 0       |
      And I should see following records in exported object report.csv placed in column 1
          | Record                               |
  ...
  Scenario: Check export from ADVISOR_RATINGS table into S3/Minio
     ...
     Then The process should finish with exit code 0
      ...
      And I should see following number of records stored in CSV objects in S3
          ...
          | rule_disable.csv                       | 0       |
          | rule_hit.csv                           | 0       |
      And I should see following records in exported object advisor_ratings.csv placed in column 2
          | Record       |
          | ruleA.error1 |
          | ruleA.error2 |
          | ruleB.error1 |
          | ruleB.error2 |
      And I should see following records in exported object advisor_ratings.csv placed in column 3
          | Record |
          | error1 |
          | error2 |
      And I should see following records in exported object advisor_ratings.csv placed in column 7
          | Record |
          | ruleA  |
          | ruleB  |
     When I delete all tables from database
  ...
  Scenario: Check export from CLUSTER_RULE_TOGGLE table into S3/Minio
     ...
     Then The process should finish with exit code 0
      ...
      And I should see following number of records stored in CSV objects in S3
          ...
          | rule_disable.csv                       | 0       |
          | rule_hit.csv                           | 0       |
      And I should see following records in exported object cluster_rule_toggle.csv placed in column 0
          | Record                               |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767aa |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ab |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ac |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ad |
      And I should see following records in exported object cluster_rule_toggle.csv placed in column 1
          | Record |
          | ruleA  |
          | ruleB  |
      And I should see following records in exported object cluster_rule_toggle.csv placed in column 7
          | Record |
          | error1 |
          | error2 |
     When I delete all tables from database
  ...
  Scenario: Check export from CLUSTER_RULE_USER_FEEDBACK table into S3/Minio
     ...
     Then The process should finish with exit code 0
      ...
      And I should see following number of records stored in CSV objects in S3
          ...
          | rule_disable.csv                       | 0       |
          | rule_hit.csv                           | 0       |
      And I should see following records in exported object cluster_rule_user_feedback.csv placed in column 0
          | Record                               |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767aa |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ab |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ac |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ad |
      And I should see following records in exported object cluster_rule_user_feedback.csv placed in column 1
          | Record |
          | ruleA  |
          | ruleB  |
      And I should see following records in exported object cluster_rule_user_feedback.csv placed in column 7
          | Record |
          | error1 |
          | error2 |
      And I should see following records in exported object cluster_rule_user_feedback.csv placed in column 3
          | Record |
          | feedbackA |
          | feedbackB |
          | feedbackC |
  ...
  Scenario: Check export from CLUSTER_USER_RULE_DISABLE_FEEDBACK table into S3/Minio
     ...
     Then The process should finish with exit code 0
      ...
      And I should see following number of records stored in CSV objects in S3
          ...
          | rule_disable.csv                       | 0       |
          | rule_hit.csv                           | 0       |
      And I should see following records in exported object cluster_user_rule_disable_feedback.csv placed in column 0
          | Record                               |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767aa |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ab |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ac |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ad |
      And I should see following records in exported object cluster_user_rule_disable_feedback.csv placed in column 2
          | Record |
          | ruleA  |
          | ruleB  |
      And I should see following records in exported object cluster_user_rule_disable_feedback.csv placed in column 6
          | Record |
          | error1 |
          | error2 |
      And I should see following records in exported object cluster_user_rule_disable_feedback.csv placed in column 3
          | Record |
          | feedbackA |
          | feedbackB |
          | feedbackC |
  ...
  Scenario: Check export from RULE_HIT table into S3/Minio
     ...
     Then The process should finish with exit code 0
      ...
      And I should see following number of records stored in CSV objects in S3
          ...
          | rule_disable.csv                       | 0       |
          | rule_hit.csv                           | 4       |
      And I should see following records in exported object rule_hit.csv placed in column 1
          | Record                               |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767aa |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ab |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ac |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ad |
      And I should see following records in exported object rule_hit.csv placed in column 2
          | Record |
          | ruleA.error1 |
          | ruleA.error2 |
          | ruleB.error1 |
          | ruleB.error2 |
      And I should see following records in exported object rule_hit.csv placed in column 3
          | Record |
          | error1 |
          | error2 |
      And I should see following records in exported object rule_hit.csv placed in column 4
          | Record |
          | template1 |
          | template2 |
          | template3 |
  ...
  Scenario: Check export from RECOMMENDATION table into S3/Minio
     ...
     Then The process should finish with exit code 0
      ...
      And I should see following number of records stored in CSV objects in S3
          ...
          | rule_disable.csv                       | 0       |
          | rule_hit.csv                           | 0       |
      And I should see following records in exported object recommendation.csv placed in column 1
          | Record                               |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767aa |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ab |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ac |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ad |
      And I should see following records in exported object recommendation.csv placed in column 2
          | Record |
          | ruleA.error1 |
          | ruleA.error2 |
          | ruleB.error1 |
          | ruleB.error2 |
      And I should see following records in exported object recommendation.csv placed in column 3
          | Record |
          | error1 |
          | error2 |
      And I should see following records in exported object recommendation.csv placed in column 4
          | Record |
          | ruleA |
          | ruleB |
     When I delete all tables from database
  ...
  Scenario: Check export from MIGRATION_INFO table into S3/Minio
     ...
     Then The process should finish with exit code 0
      ...
      And I should see following number of records stored in CSV objects in S3
          ...
          | rule_disable.csv                       | 0       |
          | rule_hit.csv                           | 0       |
      And I should see following records in exported object migration_info.csv placed in column 0
          | Record |
          | 42     |
     When I delete all tables from database
     Then I should find that the database is empty
  ...
  Scenario: Check export from CONSUMER_ERROR table into S3/Minio
     ...
     Then The process should finish with exit code 0
      ...
      And I should see following number of records stored in CSV objects in S3
          ...
          | rule_disable.csv                       | 0       |
          | rule_hit.csv                           | 0       |
      And I should see following records in exported object consumer_error.csv placed in column 0
          | Record |
          | testT  |
      And I should see following records in exported object consumer_error.csv placed in column 1
          | Record |
          | 1      |
          | 2      |
      And I should see following records in exported object consumer_error.csv placed in column 2
          | Record |
          | 0      |
          | 1      |
          | 1000   |
      And I should see following records in exported object consumer_error.csv placed in column 6
          | Record   |
          | messageX |
          | messageY |
          | messageZ |
          | messageW |
      And I should see following records in exported object consumer_error.csv placed in column 7
          | Record |
          | errorX |
          | errorY |
          | errorZ |
  ...
  Scenario: Check export from REPORT_INFO table into S3/Minio
     ...
     Then The process should finish with exit code 0
      ...
      And I should see following number of records stored in CSV objects in S3
          ...
          | rule_disable.csv                       | 0       |
          | rule_hit.csv                           | 0       |
      And I should see following records in exported object report_info.csv placed in column 1
          | Record                               |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767aa |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ab |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ac |
          | 5d5892d4-1f74-4ccf-91af-548dfc9767ad |
      And I should see following records in exported object report_info.csv placed in column 2
          | Record   |
          | 1.0      |
          | 42.5beta |
          | 1.2.3    |
  ...
  Scenario: Check export from RULE_DISABLE table into S3/Minio
     ...
     Then The process should finish with exit code 0
      ...
      And I should see following number of records stored in CSV objects in S3
          ...
          | rule_disable.csv                       | 4       |
          | rule_hit.csv                           | 0       |
      And I should see following records in exported object rule_disable.csv placed in column 0
          | Record |
          | 1      |
          | 2      |
          | 3      |
          | 4      |
      And I should see following records in exported object rule_disable.csv placed in column 1
          | Record |
          | 10     |
          | 20     |
          | 30     |
          | 40     |
      And I should see following records in exported object rule_disable.csv placed in column 2
          | Record |
          | ruleA  |
          | ruleB  |
          | ruleC  |
          | ruleD  |
      And I should see following records in exported object rule_disable.csv placed in column 3
          | Record |
          | error1 |
          | error2 |
      And I should see following records in exported object rule_disable.csv placed in column 4
          | Record         |
          | justificationX |
          | justificationY |
          | justificationZ |
